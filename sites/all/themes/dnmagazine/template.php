 ...
 */
function dnmagazine_preprocess_node(&$vars, $hook) {
  ...
  $classes[] = dnmagazine_id_safe('node-type-' . $vars['type']);
 ...
 */
function dnmagazine_preprocess_block(&$vars, $hook) {
  $block = $vars['block'];
...
function dnmagazine_preprocess_comment(&$vars, $hook) {
 ...
 * 
 */
function dnmagazine_preprocess_views_slideshow_ddblock(&$vars) {
 ...
 *
 */
function dnmagazine_preprocess_views_slideshow_ddblock_pager_content(&$vars) {
...
function dnmagazine_menu_item_link($link) {
...
/**
 *  Override breadcrumb. Add title of the page.
 */
function dnmagazine_breadcrumb($breadcrumb){
     if (!empty($breadcrumb)) {
 ...
 */
function dnmagazine_id_safe($string) {
